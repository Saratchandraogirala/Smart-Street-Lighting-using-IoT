...
const char* ssid = "Ogirala";
const char* password = "smile@123";

WiFiClient client;

unsigned long myChannelNumber = 1416948;
const char * myWriteAPIKey = "CSM1KV489D0TYPYH";
const char * myReadAPIKey = "O7UFHQL7SZIW4RA6";
